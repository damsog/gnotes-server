...
/**
 * @swagger
 * /api/objects/updateByName/{objectName}/{listName}:
 *  put:
 *      summary: Updates Object
 *      security:
 *          - bearerAuth: []
 ...
 *                                
 */
 router.put('/updateByName/:objectName/:listName' , objectController.updateByName );
 ...
 */
 ...
 /**
 * @swagger
 * /api/objects/removeOptionsByName/{objectName}/{listName}:
 *  delete:
 *      summary: Updates Object
 *      security:
 *          - bearerAuth: []
 ...
 *                                
 */
  router.delete('/removeOptionsByName/:objectName/:listName' , objectController.removeOptionsByName );
